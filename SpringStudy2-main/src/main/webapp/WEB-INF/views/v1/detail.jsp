...
<body>
    <div class="container mt-3">
        ...
        <form action="/v1/update" method="post">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                ...
                <a class="btn btn-success" href="/v1/accept/1?no=${no}">승인</a>
                <a class="btn btn-warning" href="/v1/accept/0?no=${no}">미승인</a>
                <a class="btn btn-secondary" href="/v1/list">취소</a>
            </div>
        </form>
    </div>
</body>
